    ...
    <script src="{{ asset('Minible/HTML/dist/assets/libs/select2/js/select2.min.js') }}">"></script>

    <!-- apexcharts -->
    <script src="{{ asset('Minible/HTML/dist') }}/assets/libs/apexcharts/apexcharts.min.js"></script>

    <script src="{{ asset('Minible/HTML/dist') }}/assets/js/pages/dashboard.init.js"></script>

    <!-- App js -->
    <script src="{{ asset('Minible/HTML/dist') }}/assets/js/app.js"></script>
    @stack('scripts')
</body>
