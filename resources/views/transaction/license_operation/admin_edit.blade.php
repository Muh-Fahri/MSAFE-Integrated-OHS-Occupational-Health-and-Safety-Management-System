<x-app-layout>
    ...
    <form action="{{ route('transaction-license.admin_update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card mt-3">
            <div class="card-body">
                    ...
                    <div class="col-12 mb-4">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input name="type" type="text" class="form-control rounded-pill border-2"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label fw-bold">Theory Tester</label>
                        <select name="theory_tester_id" class="form-select rounded-pill text-secondary border-2"
                            style="border-color: #dee2e6; padding-left: 1.5rem;">
                            <option value="">Select User</option>
                            @foreach ($list_user as $user_id => $user_name)
                                <option value="{{ $user_id }}"
                                    {{ old('theory_tester_id', $data->theory_tester_id) == $user_id ? 'selected' : '' }}>
                                    {{ $user_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold">Practice Tester</label>
                        <select name="practice_tester_id" class="form-select rounded-pill text-secondary border-2"
                            style="border-color: #dee2e6; padding-left: 1.5rem;">
                            <option value="">Select User</option>
                            @foreach ($list_user as $user_id => $user_name)
                                <option value="{{ $user_id }}"
                                    {{ old('practice_tester_id', $data->practice_tester_id) == $user_id ? 'selected' : '' }}>
                                    {{ $user_name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label fw-bold">First Aid Trainer</label>
                        <select name="first_aid_trainer_id" class="form-select rounded-pill text-secondary border-2"
                            style="border-color: #dee2e6; padding-left: 1.5rem;">
                            <option value="">Select User</option>
                            @foreach ($list_user as $user_id => $user_name)
                                <option value="{{ $user_id }}"
                                    {{ old('first_aid_trainer_id', $data->first_aid_trainer_id) == $user_id ? 'selected' : '' }}>
                                    {{ $user_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold">DDC Trainer</label>
                        <select name="ddc_trainer_id" class="form-select rounded-pill text-secondary border-2"
                            style="border-color: #dee2e6; padding-left: 1.5rem;">
                            <option value="">Select User</option>
                            @foreach ($list_user as $user_id => $user_name)
                                <option value="{{ $user_id }}"
                                    {{ old('ddc_trainer_id', $data->ddc_trainer_id) == $user_id ? 'selected' : '' }}>
                                    {{ $user_name }}
                                </option>
                            @endforeach
                        </select>
