...
class IncidentInvestigationExport implements FromCollection, WithHeadings {
    ...
    public function collection() {
        ...
        if($action=='MONITORING') {
            ...
            $query->whereIn('status', ['INVESTIGATION_REQUIRED', 'INVESTIGATION_REJECTED', 'INVESTIGATION_APPROVAL_REQUIRED', 'INVESTIGATION_COMPLETED'])->where('reporter_id', $user->id);
        }
